...
async function seed() {
  try {
    ...
    const skillData = [
      ...
      // Design Skills
      { name: "UI Design", category: "Design", type: "skill" },
      { name: "UX Design", category: "Design", type: "skill" },
      { name: "Graphic Design", category: "Design", type: "skill" },
      { name: "Motion Graphics", category: "Design", type: "skill" },
      { name: "Video Editing", category: "Design", type: "skill" },
      { name: "3D Modeling", category: "Design", type: "skill" },
      // Design Tools
      { name: "Figma", category: "Design", type: "tool" },
      { name: "Adobe Photoshop", category: "Design", type: "tool" },
      { name: "Adobe Illustrator", category: "Design", type: "tool" },
      { name: "Adobe XD", category: "Design", type: "tool" },
      { name: "Sketch", category: "Design", type: "tool" },
      { name: "Canva", category: "Design", type: "tool" },
      { name: "After Effects", category: "Design", type: "tool" },
      { name: "Premiere Pro", category: "Design", type: "tool" },
      { name: "Blender", category: "Design", type: "tool" },
      // Marketing Skills
      { name: "SEO", category: "Marketing", type: "skill" },
      { name: "Content Marketing", category: "Marketing", type: "skill" },
      { name: "Social Media Marketing", category: "Marketing", type: "skill" },
      { name: "Email Marketing", category: "Marketing", type: "skill" },
      { name: "PPC Advertising", category: "Marketing", type: "skill" },
      // Marketing Tools
      { name: "Google Ads", category: "Marketing", type: "tool" },
      { name: "Facebook Ads", category: "Marketing", type: "tool" },
      { name: "Google Analytics", category: "Marketing", type: "tool" },
      { name: "HubSpot", category: "Marketing", type: "tool" },
      { name: "Mailchimp", category: "Marketing", type: "tool" },
      // AI & Data Skills
      { name: "Machine Learning", category: "AI & Data", type: "skill" },
      { name: "Deep Learning", category: "AI & Data", type: "skill" },
      { name: "Natural Language Processing", category: "AI & Data", type: "skill" },
      { name: "Data Analysis", category: "AI & Data", type: "skill" },
      { name: "Data Visualization", category: "AI & Data", type: "skill" },
      // AI & Data Tools
      { name: "TensorFlow", category: "AI & Data", type: "tool" },
      { name: "PyTorch", category: "AI & Data", type: "tool" },
      { name: "OpenAI API", category: "AI & Data", type: "tool" },
      { name: "LangChain", category: "AI & Data", type: "tool" },
      { name: "Pandas", category: "AI & Data", type: "tool" },
      { name: "Power BI", category: "AI & Data", type: "tool" },
      { name: "Tableau", category: "AI & Data", type: "tool" },
      // Mobile
      ...
      // Other Tools
      { name: "Git", category: "Tools", type: "tool" },
      { name: "JIRA", category: "Tools", type: "tool" },
      { name: "Slack", category: "Tools", type: "tool" },
      { name: "Notion", category: "Tools", type: "tool" },
      { name: "WordPress", category: "Tools", type: "tool" },
      { name: "Shopify", category: "Tools", type: "tool" },
      { name: "Webflow", category: "Tools", type: "tool" },
    ]
